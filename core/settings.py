...
SECRET_KEY = 'django-insecure-65vmeqf95qztlhcfib=_4zcu1()a4l@*t-1c%*^gxe7v+%k1c0'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Directory for static files during production
